...
namespace Leto2bot.Services.Database
{
    ...
    public class Leto2ContextFactory : IDbContextFactory<Leto2Context>
    {
        /// <summary>
        /// :\ Used for migrations
        /// </summary>
        ...
        /// <returns></returns>
        public Leto2Context Create(DbContextFactoryOptions options)
        {
            var optionsBuilder = new DbContextOptionsBuilder();
            optionsBuilder.UseSqlite("Filename=./data/Leto2bot.db");
            var ctx = new Leto2Context(optionsBuilder.Options);
            ctx.Database.SetCommandTimeout(60);
            return ctx;
        }
    }

    public class Leto2Context : DbContext
    {
        ...
        public Leto2Context() : base()
        {

        }

        public Leto2Context(DbContextOptions options) : base(options)
        {
        }

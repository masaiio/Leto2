...
{
    public partial class Utility : Leto2TopLevelModule
    {
        ...
        public Utility(Leto2bot bot, DiscordSocketClient client, IStatsService stats, IBotCredentials creds)
        {
            _client = client;
            _stats = stats;
            _creds = creds;
        ...
        {            
            await Context.Channel.EmbedAsync(
                new EmbedBuilder().WithOkColor()
                    .WithAuthor(eab => eab.WithName($"Leto2Bot v{StatsService.BotVersion}")
                                          .WithUrl("http://leto2bot.readthedocs.io/en/latest/")

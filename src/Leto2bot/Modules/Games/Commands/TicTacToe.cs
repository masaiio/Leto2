...
namespace Leto2bot.Modules.Games
{
    ...
    {
        [Group]
        public class TicTacToeCommands : Leto2Submodule
        {
            //channelId/game
        ...
        public class TicTacToe
        {
            ...
            public TicTacToe(LetoStrings strings, DiscordSocketClient client, ITextChannel channel, IGuildUser firstUser)
            {
                _channel = channel;
                _strings = strings;
                _client = client;

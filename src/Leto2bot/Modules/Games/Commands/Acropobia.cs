...
namespace Leto2bot.Modules.Games
{
    ...
    {
        [Group]
        public class Acropobia : Leto2Submodule
        {
        ...
        public class AcrophobiaGame
        {
            ...
            private readonly Leto2Random _rng;
            ...
            public AcrophobiaGame(DiscordSocketClient client, LetoStrings strings, ITextChannel channel, int time)
            {

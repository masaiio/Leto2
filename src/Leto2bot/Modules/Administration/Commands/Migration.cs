...
using Leto2bot.Modules.Administration.Commands.Migration;
...
namespace Leto2bot.Modules.Administration
{
    ...
    {
        [Group]
        public class Migration : Leto2Submodule
        {
            ...
            {
                var db = new SqliteConnection("Data Source=data/leto2bot.sqlite");

                if (!File.Exists("data/leto2bot.sqlite"))
                {
                ...
                db.Close();
                try { File.Move("data/leto2bot.sqlite", "data/DELETE_ME_leto2bot.sqlite"); } catch { }
            }

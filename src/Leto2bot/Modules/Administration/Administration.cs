...
{
    public partial class Administration : Leto2TopLevelModule
    {
        private IGuild _leto2SupportServer;
        ...
        public async Task Donators()
        {
            ...
            _leto2SupportServer = _leto2SupportServer ?? (await Context.Client.GetGuildAsync(117523346618318850));

            var patreonRole = _leto2SupportServer?.GetRole(236667642088259585);
            if (patreonRole == null)
                return;

            var usrs = (await _leto2SupportServer.GetUsersAsync()).Where(u => u.RoleIds.Contains(236667642088259585u));

...
{
    public abstract class Leto2TopLevelModule : ModuleBase
    {
        ...
        //{
        //    var title = Leto2Bot.ResponsesResourceManager.GetString(titleKey, cultureInfo);
        //    var text = Leto2Bot.ResponsesResourceManager.GetString(textKey, cultureInfo);
    ...
    public abstract class Leto2Submodule : Leto2TopLevelModule
    {
        protected Leto2Submodule() : base(false)
        {
        }
    }
}
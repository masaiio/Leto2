...
namespace Leto2bot.Modules.Music
{
    [NoPublicBot]
    public class Music : Leto2TopLevelModule 
    {
        ...
        public async Task SoundCloudPl([Remainder] string pl)
        {
            ...
            {
                var scvids = JObject.Parse(await http.GetStringAsync($"https://scapi.leto2bot.me/resolve?url={pl}").ConfigureAwait(false))["tracks"].ToObject<SoundCloudVideo[]>();
                IUserMessage msg = null;

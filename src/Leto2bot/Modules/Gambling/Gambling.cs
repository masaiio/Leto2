...
namespace Leto2bot.Modules.Gambling
{
    public partial class Gambling : Leto2TopLevelModule
    {
        ...
        public async Task Raffle([Remainder] IRole role = null)
        {
            ...
            var usr = membersArray[new Leto2Random().Next(0, membersArray.Length)];
        ...
        public async Task BetRoll(long amount)
        {
            ...
            var rnd = new Leto2Random().Next(0, 101);
